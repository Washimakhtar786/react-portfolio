const projectsData = [
  {
    ...
    description:
      "Modern task management application with reusable React components and responsive UI.",
...

  {
    ...
    description:
      "Reusable UI component system with scalable frontend architecture and clean design patterns.",
...

  {
    ...
    description:
      "Modern responsive portfolio website with glassmorphism effects and premium UI design.",
...

  {
    ...
    description:
      "Responsive blog application with reusable layouts and modern typography.",
...

  {
    ...
    description:
      "Professional admin dashboard UI with cards, analytics, and responsive layouts.",
...

  {
    ...
    description:
      "Modern ecommerce frontend interface with reusable product components and filtering UI.",
...

  {
    ...
    description:
      "Weather forecasting application with API integration concepts and responsive UI.",
...

  {
    ...
    description:
      "Expense management app with transaction tracking and clean dashboard interface.",
...

  {
    ...
    description:
      "Interactive quiz application with score tracking and responsive frontend design.",
